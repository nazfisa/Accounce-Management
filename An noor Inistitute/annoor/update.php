...
<table>
 ...
 <tr>
  <td>Gender</td>
  <td>
  <input type="radio" name="gender" <?php if($getData['gender'] == "male") { echo "checked"; }?> value="<?php echo $getData['gender'] ?>">Male
  <input type="radio" name="gender" <?php if($getData['gender'] == "female") { echo "checked"; }?> value="<?php echo $getData['gender']  ?>">Female
  </td>
  </tr>
 <tr>
  <td></td>
